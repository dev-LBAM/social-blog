...
export default function HomePage() 
{
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-page">
      ...
      <div className="max-w-md w-full p-8 rounded-xl  bg-box drop-shadow-lg" >
        ...
        <div className="flex items-center gap-2 text-input-title pt-8 rounded-xl max-w-md w-full">
          ...
          <button
            ...
            className=".text-input-title  drop-shadow-md underline transition-transform duration-200 ease-in-out hover:scale-105 cursor-pointer "
          >
